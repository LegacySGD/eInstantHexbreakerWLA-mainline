...
public class HexbreakerWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(HexbreakerWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/HexbreakerWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/HexbreakerWLAIW/InitOutcome.xml").getDocumentElement();
